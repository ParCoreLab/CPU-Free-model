#ifndef INC_CG_BASELINE_DISCRETE_STANDARD_NVSHMEM_CUH
#define INC_CG_BASELINE_DISCRETE_STANDARD_NVSHMEM_CUH
...
#endif  // INC_CG_BASELINE_DISCRETE_STANDARD_NVSHMEM_CUH
