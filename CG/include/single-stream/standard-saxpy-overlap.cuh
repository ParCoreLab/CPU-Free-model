#ifndef INC_CG_SINGLE_STREAM_STANDARD_SAXPY_OVERLAP_CUH
#define INC_CG_SINGLE_STREAM_STANDARD_SAXPY_OVERLAP_CUH

#include "../common.h"

namespace SingleStreamStandardSaxpyOverlap {
...
#endif  // INC_CG_SINGLE_STREAM_STANDARD_SAXPY_OVERLAP_CUH
