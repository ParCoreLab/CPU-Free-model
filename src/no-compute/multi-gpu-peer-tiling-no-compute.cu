...
__global__ void __launch_bounds__(1024, 1)
    boundary_sync_kernel(real *a_new, real *a, volatile real *local_halo_buffer_for_top_neighbor,
                         volatile real *local_halo_buffer_for_bottom_neighbor,
                         volatile real *remote_my_halo_buffer_on_top_neighbor,
                         volatile real *remote_my_halo_buffer_on_bottom_neighbor,
                         volatile int *local_is_top_neighbor_done_writing_to_me,
...
#pragma omp barrier
        ...
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::iy_start, &iy_start, sizeof(iy_start));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::iy_end, &iy_end[dev_id],
                           sizeof(iy_end[dev_id]));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::nx, &nx, sizeof(nx));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::comp_tile_size_x, &comp_tile_size_x,
                           sizeof(comp_tile_size_x));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::comp_tile_size_y, &comp_tile_size_y,
                           sizeof(comp_tile_size_y));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::comm_tile_size, &comm_tile_size,
                           sizeof(comm_tile_size));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::num_comp_tiles_x, &num_comp_tiles_x,
                           sizeof(num_comp_tiles_x));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::num_comp_tiles_y, &num_comp_tiles_y,
                           sizeof(num_comp_tiles_y));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::num_comm_tiles, &num_comm_tiles,
                           sizeof(num_comm_tiles));
        cudaMemcpyToSymbol(MultiGPUPeerTilingNoCompute::iter_max, &iter_max, sizeof(iter_max));
