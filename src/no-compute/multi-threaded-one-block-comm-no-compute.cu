...
#pragma omp barrier
        ...
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::iy_start, &iy_start,
                           sizeof(iy_start));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::iy_end, &iy_end[dev_id],
                           sizeof(iy_end[dev_id]));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::nx, &nx, sizeof(nx));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::comp_tile_size_x,
                           &comp_tile_size_x, sizeof(comp_tile_size_x));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::comp_tile_size_y,
                           &comp_tile_size_y, sizeof(comp_tile_size_y));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::comm_tile_size, &comm_tile_size,
                           sizeof(comm_tile_size));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::num_comp_tiles_x,
                           &num_comp_tiles_x, sizeof(num_comp_tiles_x));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::num_comp_tiles_y,
                           &num_comp_tiles_y, sizeof(num_comp_tiles_y));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::num_comm_tiles, &num_comm_tiles,
                           sizeof(num_comm_tiles));
        cudaMemcpyToSymbol(SSMultiThreadedOneBlockCommNoCompute::iter_max, &iter_max,
                           sizeof(iter_max));
...
#pragma omp barrier
        ...
        CUDA_RT_CALL(
            cudaLaunchCooperativeKernel((void *)SSMultiThreadedOneBlockCommNoCompute::jacobi_kernel,
