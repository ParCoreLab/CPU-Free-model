...
namespace SSSingleThreadedTwoBlockComm {
...
int SSSingleThreadedTwoBlockComm::init(int argc, char *argv[]) {
    ...
    for (int dev_id = 0; dev_id < num_devices; ++dev_id) {
        ...
        CUDA_RT_CALL(cudaLaunchCooperativeKernel((void *) SSSingleThreadedTwoBlockComm::jacobi_kernel,
