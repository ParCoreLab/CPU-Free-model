...
#pragma omp barrier
        ...
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::iy_start, &iy_start, sizeof(iy_start));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::iy_end, &iy_end[dev_id],
                           sizeof(iy_end[dev_id]));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::nx, &nx, sizeof(nx));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::comp_tile_size_x, &comp_tile_size_x,
                           sizeof(comp_tile_size_x));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::comp_tile_size_y, &comp_tile_size_y,
                           sizeof(comp_tile_size_y));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::comm_tile_size, &comm_tile_size,
                           sizeof(comm_tile_size));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::num_comp_tiles_x, &num_comp_tiles_x,
                           sizeof(num_comp_tiles_x));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::num_comp_tiles_y, &num_comp_tiles_y,
                           sizeof(num_comp_tiles_y));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::num_comm_tiles, &num_comm_tiles,
                           sizeof(num_comm_tiles));
        cudaMemcpyToSymbol(SSMultiThreadedTwoBlockComm::iter_max, &iter_max, sizeof(iter_max));
