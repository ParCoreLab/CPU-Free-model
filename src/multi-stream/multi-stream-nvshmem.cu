...
int MultiStreamNVSHMEM::init(int argc, char *argv[]) {
...
#pragma omp barrier
        ...
        CUDA_RT_CALL(cudaLaunchCooperativeKernel((void *)MultiStreamNVSHMEM::jacobi_kernel,
                                                 dim_grid, dim_block, kernelArgsInner, 0,
                                                 inner_domain_stream));

        CUDA_RT_CALL(cudaLaunchCooperativeKernel((void *)MultiStreamNVSHMEM::boundary_sync_kernel,
