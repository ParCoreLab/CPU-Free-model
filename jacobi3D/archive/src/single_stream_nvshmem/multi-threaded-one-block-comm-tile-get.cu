...
namespace SSMultiThreadedOneBlockCommTileGetNvshmem {
...
int SSMultiThreadedOneBlockCommTileGetNvshmem::init(int argc, char *argv[]) {
    ...
    CUDA_RT_CALL((cudaError_t)nvshmemx_collective_launch(
        (void *)SSMultiThreadedOneBlockCommTileGetNvshmem::jacobi_kernel, dim_grid, dim_block,
