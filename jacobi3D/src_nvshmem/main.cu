...
int main(int argc, char *argv[]) {
    const std::array versions{
        ...
        make_pair("NVSHMEM Baseline Multi Threaded Optimized",
        ...
        make_pair("NVSHMEM Single stream multi threaded Partitioned,2 SM Comm",
        ...
        make_pair("NVSHMEM Single stream multi threaded Partitioned,2 SM Comm (No Computation)",
