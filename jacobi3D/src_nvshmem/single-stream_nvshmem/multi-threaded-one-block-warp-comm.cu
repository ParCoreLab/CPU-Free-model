...
#include "../../include_nvshmem/single-stream_nvshmem/multi-threaded-one-block-warp-comm.cuh"
                ...
                for (int comm_tile_idx_x = 0; comm_tile_idx_x < num_comm_tiles_x;
                    ...
                    if (iy < ny - 1 && ix < nx - 1) {
                        ...
                        nvshmemx_float_put_nbi_warp(
                            ...
                            min(warpSize, comm_tile_size_x - comm_tile_start_x), top);
                    ...
                    if (iy < ny - 1 && ix < nx - 1) {
                        ...
                        nvshmemx_float_put_nbi_warp(
                            ...
                            a_new + iz_start * ny * nx + iy,
                            min(32, comm_tile_size_x - comm_tile_start_x), bottom);
