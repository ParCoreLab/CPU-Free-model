...
int main(int argc, char *argv[])
{
    const std::array versions{
        ...
        make_pair("NVSHMEM Single stream multi threaded contiguous (one thread block communicates)", SSMultiThreadedOneBlockCommContiguousNvshmem::init),
        ...
        make_pair("NVSHMEM Single stream multi threaded contiguous (one thread block communicates; no computation)", SSMultiThreadedOneBlockCommContiguousNvshmemNoCompute::init),
