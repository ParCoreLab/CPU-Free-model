...
namespace SSMultiThreadedOneBlockCommBulkNvshmemNoCompute
{
...
int SSMultiThreadedOneBlockCommBulkNvshmemNoCompute::init(int argc, char *argv[])
{
    ...
    CUDA_RT_CALL((cudaError_t)nvshmemx_collective_launch(
        (void *)SSMultiThreadedOneBlockCommBulkNvshmemNoCompute::jacobi_kernel, dim_grid, dim_block, kernelArgs,
        0, nullptr));
