...
namespace SSMultiThreadedOneBlockCommOriginalGetNvshmemNoCompute
{
...
int SSMultiThreadedOneBlockCommOriginalGetNvshmemNoCompute::init(int argc, char *argv[])
{
    ...
    CUDA_RT_CALL((cudaError_t)nvshmemx_collective_launch(
        (void *)SSMultiThreadedOneBlockCommOriginalGetNvshmemNoCompute::jacobi_kernel, dim_grid, dim_block,
