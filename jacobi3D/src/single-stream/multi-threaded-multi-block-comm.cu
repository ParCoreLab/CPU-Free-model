...
#pragma omp barrier
        ...
        CUDA_RT_CALL(cudaMemcpy((void *)halo_buffer_for_top_neighbor[top], a[dev_id]+ iz_end[dev_id] * ny * nx , nx * ny * sizeof(real), cudaMemcpyDeviceToDevice));
        CUDA_RT_CALL(cudaMemcpy((void *)halo_buffer_for_bottom_neighbor[bottom], a[dev_id] , nx * ny * sizeof(real), cudaMemcpyDeviceToDevice));
