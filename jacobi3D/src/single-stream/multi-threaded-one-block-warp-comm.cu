...
namespace SSMultiThreadedOneBlockWarpComm {
...
int SSMultiThreadedOneBlockWarpComm::init(int argc, char *argv[]) {
...
#pragma omp barrier
        ...
        CUDA_RT_CALL(cudaLaunchCooperativeKernel((void *)SSMultiThreadedOneBlockWarpComm::jacobi_kernel,
