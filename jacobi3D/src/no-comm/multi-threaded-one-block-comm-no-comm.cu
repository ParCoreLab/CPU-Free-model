...
namespace SSMultiThreadedOneBlockCommNoComm {
...
int SSMultiThreadedOneBlockCommNoComm::init(int argc, char *argv[]) {
...
#pragma omp barrier
        ...
        CUDA_RT_CALL(
            cudaLaunchCooperativeKernel((void *)SSMultiThreadedOneBlockCommNoComm::jacobi_kernel,
