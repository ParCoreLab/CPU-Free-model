...
namespace SSMultiThreadedTwoBlockCommNoComm {
...
int SSMultiThreadedTwoBlockCommNoComm::init(int argc, char *argv[]) {
...
#pragma omp barrier
        ...
        CUDA_RT_CALL(
            cudaLaunchCooperativeKernel((void *)SSMultiThreadedTwoBlockCommNoComm::jacobi_kernel,
